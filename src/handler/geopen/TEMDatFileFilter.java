 ...
 */
public class TEMDatFileFilter extends JFileChooser {

    public TEMDatFileFilter() {
        super();
        setAcceptAllFileFilterUsed(false);
        addFilter();
    }

    public TEMDatFileFilter(String currentDirectoryPath) {
    ...
    public void addFilter() {
        this.addChoosableFileFilter(new MyFileFilter(new String[]{".dat"}, "dat (*.dat)"));
    }
